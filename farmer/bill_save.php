...
$targetFile = '../rps/img/farmer/' . basename($_FILES["bcopy"]["name"]);
...
$statement = $db->prepare( "INSERT INTO bills (b_id, name, years, date_period, bill_date, bill_no, solid_qty, dealer_licence, amount, dat,lstat,bstat,bcopy)
