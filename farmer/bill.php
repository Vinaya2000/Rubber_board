                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
						...
						<div class="panel-body"> 
                             ...
                             <form method="post" action="bill_save.php" autocomplete="off" enctype="multipart/form-data">
                              <!-- First Row Start-->
                                <div class="row">                                                                 
                                     	...
                                     	<table id="resultTable" data-responsive="table"  class="table table-bordered">
                                        	<thead>
												...
												for($i=0; $rows= $result->fetch(); $i++){	?>
                                                	...
                                                	<td>
                                                		<div class="btn-group">														
														<a href="delete_bill.php?delete=<?php echo $rows['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														</div>
                                                	</td>
                                                	</tr>
													<?php } ?>
