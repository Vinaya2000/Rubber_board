                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
						...
						<div class="panel-body"> 
                             ...
                             <form method="post" action="action/subsidy_save.php" autocomplete="off" enctype="multipart/form-data">
                              ...
                              <!-- First Row Start-->
                                <div class="row">                                                                 
									...
									<div class="col-md-2 col-sm-1 col-xs-12">
										...
										<input type="number"  name="year"  class="form-control" required min="0" step="0.01">  
									</div>	
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-2 col-sm-6 col-xs-12">
                                        <label style="float:left">Bill No</label>
                                         <input type="number"  name="bill_no"  class="form-control" required min="0" step="0.01"> 
                                    </div>
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12">
										...
										<input type="number"  name="d_licence_no"  class="form-control" required min="0" step="0.01"> 
									</div>	
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <br>
                                     	<table id="resultTable" data-responsive="table"  class="table table-bordered">
                                        	<thead>
                                                ...
                                                <tbody> 
                                                <?php 
												$result =$db ->prepare("SELECT * FROM subsidy where lstat='pending'");
												$result->execute();	
												for($i=0; $rows= $result->fetch(); $i++){	?>
                                               	    <tr>
                                                	...
                                                	<td>
                                                		<div class="btn-group">														
														<a href="action/delete_subsidy.php?delete=<?php echo $rows['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														</div>
                                                	</td>
                                                	</tr>
													<?php } ?>
