        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Farmer Information Update</h3>
            </div>
         	  ...
         	  <div class="box-body no-padding">
				...
				<tr>
					...
					<td>
					<div class="btn-group">
						<a href="edit-farmer.php?edit=<?php echo $rows['id']; ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
						<a href="action/delete_farmer.php?delete=<?php echo $rows['id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
					</div>	
					</td>
				</tr>
				<?php } ?>
