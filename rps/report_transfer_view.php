      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  amount_transfer where  b_id= '$b_id' and date >= '$fdate' AND date <= '$tdate' order by date asc");
				$result->execute();
