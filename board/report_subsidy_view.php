     ...
     <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  subsidy where bstat='accept' and b_id= '$b_id' and dat >= '$fdate' AND dat <= '$tdate' order by dat asc");
				$result->execute();
				for($i=0; $row = $result->fetch(); $i++)
					{				
						 ...
						 echo"<td>".$row["date_period"]."</td>";
						 echo"<td>".$row["bill_date"]."</td>";
						 echo"<td>".$row["bill_no"]."</td>";
						 echo"<td>".$row["solid_qty"]."</td>";	
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a type="button" class="btn btn-danger pull-right" style="margin-right: 5px; width:180px;" href="report_subsidy.php">
