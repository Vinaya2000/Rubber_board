              ...
              <h3 class="box-title">All Farmers</h3>
         	  ...
         	  <div class="box-body no-padding">
				...
				<tr>
                    ...
                    <td>
                    	<a href="../rps/img/farmer/<?php echo $rows['bank_passbook_copy'];?>" target="_blank">Download</a>
                    </td>
                    <td>
                    	<a href="../rps/img/farmer/<?php echo $rows['adhar_copy'];?>" target="_blank">Download</a>
                    </td>
                    <td>
                    	<a href="../rps/img/farmer/<?php echo $rows['tax_reciepts'];?>" target="_blank">Download</a>
                    </td>
				</tr>
				<?php } ?>
				</tbody>
