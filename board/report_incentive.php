            ...
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Incentive Report</h3>
                </div>
                
                <div class="box-body no-padding">
				 <div class="box-body">
					<form method="post" action="report_incentive_view.php" autocomplete="off">
                            ...
                            <label>Beneficiary ID</label>
                                <input list="bencid" placeholder="Search" required class="form-control" name="b_id">
                                    <datalist id="bencid">
                                        ...
                                        <?php
                                            $result = $db->prepare("SELECT distinct(b_id) FROM incentive");
                                            $result->execute();
