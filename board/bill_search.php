        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Bills Search</h3>
            </div>
         	  ...
         	  <div class="box-body no-padding">
                ...
                <tbody>				
				<?php 
				$result =$db ->prepare("SELECT * FROM bills where lstat='accept' and bstat='pending'");
				$result->execute();	
				for($i=0; $rows= $result->fetch(); $i++){	?>
                    ...
                    <td>
					<div class="btn-group">
						<a href="action/bill_accept.php?id=<?php echo $rows['id']; ?>" class="btn btn-block btn-info"><i class="fa fa-forward" aria-hidden="true"></i></a>
					</div>	
					</td>
                    <td>
					<div class="btn-group">
						<a href="action/bill_cancel.php?id=<?php echo $rows['id']; ?>" class="btn btn-block btn-danger"><i class="fa fa-forward" aria-hidden="true"></i></a>
					</div>	
					</td>			
					</tr>
					<?php } ?>
