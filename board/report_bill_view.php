     ...
     <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  bills where bstat='accept' and b_id= '$b_id' and dat >= '$fdate' AND dat <= '$tdate' order by dat asc");
				$result->execute();
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a type="button" class="btn btn-danger pull-right" style="margin-right: 5px; width:180px;" href="report_bill.php">
